<p>
  ...
  <a href="https://snyk.io/test/github/rochejul/web-component-attribute-polyfill">
    <img src="https://snyk.io/test/github/rochejul/web-component-attribute-polyfill/badge.svg?targetFile=packages/test-performance/package.json" alt="Known Vulnerabilities">
  </a>
</p>

# @web-component-attribute-polyfill/test-performance

Performance testing of the polyfill
